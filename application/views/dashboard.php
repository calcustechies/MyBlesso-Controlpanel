   ...
   <!--                    <div class="app-content">-->
			...
			<!--					<div class="card">-->
			<!--						<div class="card-header">-->
			<!--							<h3 class="card-title">Visitors and Daily Visitors</h3>-->
			<!--						</div>-->
			<!--						<div class="card-body">-->
			...
			<!--						<div class="card-body">-->
			<!--							<div class="activity">-->
			<!--								<img src="<?php echo base_url();?>/assets/images/users/male/24.jpg" alt="" class="img-activity">-->
			...
			<!--									</div>-->
			<!--								</div>-->
			<!--								<img src="<?php echo base_url();?>/assets/images/users/female/10.jpg" alt="" class="img-activity">-->
			<!--								<div class="time-activity">-->
			<!--									<div class="item-activity">-->
			...
			<!--									</div>-->
			<!--								</div>-->
			<!--								<img src="<?php echo base_url();?>/assets/images/users/male/4.jpg" alt="" class="img-activity">-->
			<!--								<div class="time-activity">-->
			<!--									<div class="item-activity">-->
			...
			<!--									</div>-->
			<!--								</div>-->
			<!--								<img src="<?php echo base_url();?>/assets/images/users/female/8.jpg" alt="" class="img-activity">-->
			...
			<!--										<span class="avatar brround cover-image cover-image" data-image-src="<?php echo base_url();?>/assets/images/users/female/12.jpg" ></span>-->
			<!--										<span class="avatar brround cover-image cover-image" data-image-src="<?php echo base_url();?>/assets/images/users/female/21.jpg" ></span>-->
			<!--										<span class="avatar brround cover-image cover-image" data-image-src="<?php echo base_url();?>/assets/images/users/female/29.jpg"></span>-->
			<!--										<span class="avatar brround cover-image cover-image" data-image-src="<?php echo base_url();?>/assets/images/users/female/2.jpg"></span>-->
			<!--										<span class="avatar brround cover-image cover-image" data-image-src="<?php echo base_url();?>/assets/images/users/male/34.jpg"></span>-->
			...
			<!--								<a href="jobs.html"></a>-->
			<!--								<img src="<?php echo base_url();?>/assets/images/products/products/h4.jpg" alt="img" class="cover-image">-->
			<!--							</div>-->
			...
			<!--							<div class="item-card7-imgs">-->
			<!--								<a href="jobs.html"></a>-->
			<!--								<img src="<?php echo base_url();?>/assets/images/products/products/j3.jpg" alt="img" class="cover-image">-->
			<!--							</div>-->
			<!--							<div class="item-card7-overlaytext">-->
			<!--								<a href="jobs.html" class="text-white"> Jobs</a>-->
