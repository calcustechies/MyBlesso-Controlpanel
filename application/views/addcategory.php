				...
				<div class="app-content">
					<div class="side-app">
						<div class="page-header">
							...
							<form class="form-horizontal" enctype="multipart/form-data" action="<?php echo base_url('CategoryCtrl/addcategory')?>" method="POST">
								...
								<div class="card">
									...
									<div class="card-body">
										<div class="input-group mb-3">
											...
											<div class="input-group mb-3">
											<label class="control-label col-md-3 col-sm-3 col-xs-3 mt-2">CATEGORY IMAGE</label>
